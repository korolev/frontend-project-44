...
const getGameOverMessage = (userAnswer, rightAnswer, userName) => `"${userAnswer}" is wrong answer ;(. Correct answer was "${rightAnswer}". \nLet's try again, ${userName}!`;
...
export function runGame(userName = 'John Doe') {
